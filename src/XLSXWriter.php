...
class XLSXWriter
{
	...
	/**
	 * 设置表头 （包括sheet名称，表头名称和数据类型）
	 * @param $sheet_name  //sheet名称
	 * @param array $header_types //表头
    ...
    $style = &$col_options;
		//col_widths 宽       //freeze_row冻结行     //freeze_columns 冻结列  //auto_filter 自动筛选
	 ...
	 * 合并单元格
	 * @param $sheet_name
	 * @param $start_cell_row  //开始行
	 * @param $start_cell_column //开始列
	 * @param $end_cell_row
	 ...
	 * 数据批量导入
	 * @param array $data  数据
	 * @param string $sheet_name  sheet1
	 * @param array $header_types 表头类型
	@author baisaiyu
